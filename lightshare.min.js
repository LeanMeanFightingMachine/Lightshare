...
$(obj).offset();if($(self.lightshareDO).outerWidth()+offset["left"]>$(window).width())offset["left"]=$(window).width()-$(self.lightshareDO).outerWidth();if($(self.lightshareDO).outerHeight()+offset["top"]>$(window).height())offset["top"]=$(window).height()-$(self.lightshareDO).outerHeight();self.lightshareDO.css({"left":offset["left"],"top":offset["top"]})}};lightshare.prototype.closeHandler=function(){var self=this;self.isOpen=false;self.lightshareDO.stop().css({"top":-100})};$(function(){lightshare.init()});
